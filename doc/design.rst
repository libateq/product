...
often something that gets bought or sold.
...
These properties include things like its list price, its type, what
...
It does, however, have some properties such as the description and cost price
that are specific to each variant.
